...
export type PageModelContentField = BiographyRecord | FooterRecord | HairMenuRecord | HeroRecord | ImageRecord | TextImageRecord | TextRecord | YoutubeVideoRecord;
